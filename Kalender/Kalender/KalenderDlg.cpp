...
// KalenderDlg.cpp : implementation file
//
...
CKalenderDlg::CKalenderDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_KALENDER_DIALOG, pParent)
{
...
BEGIN_MESSAGE_MAP(CKalenderDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
END_MESSAGE_MAP()
